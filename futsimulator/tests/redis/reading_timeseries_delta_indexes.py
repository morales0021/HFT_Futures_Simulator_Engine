...
info_dat = (
    datetime(year=2024, month=4, day=3, hour = 4, minute = 1, tzinfo = pytz.utc),
    datetime(year=2024, month=4, day=3, hour = 12, minute = 0, tzinfo = pytz.utc),
    datetime(year=2024, month=4, day=3, hour = 12, minute=30, tzinfo = pytz.utc)
    )
